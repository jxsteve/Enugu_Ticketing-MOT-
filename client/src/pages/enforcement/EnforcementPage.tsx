...
import type { Driver, Offence, Ticket } from '@/types';
    ...
    <div className={styles.page}>
      ...
      {driver && !loading && (
        <Card className={styles.driverCard}>
          ...
          {/* Step 1: Issue Ticket */}
          {driver.compliance_status !== 'Compliant' && flowStep === 'search' && (
          ...
          {/* Step 2: Ticket Issued — Show Payment Instructions */}
            ...
            <div className={styles.ticketSection}>
              ...
              <div className={styles.receiptCard} ref={receiptRef}>
                ...
                <div className="receipt-footer">
                  This receipt confirms payment for the above violation. Present this to enforcement officers as proof of payment.
